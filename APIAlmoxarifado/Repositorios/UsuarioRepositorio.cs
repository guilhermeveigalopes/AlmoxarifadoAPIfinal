...
namespace APIAlmoxarifado.Repositorios
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public UsuarioRepositorio(SistemaTarefasDBContext sistemTarefasDBContext)
        {
            _dbContext = sistemTarefasDBContext;
        }
        ...
        public Task<UsuarioModel> Atualizar(UsuarioModel usuarioModel)
        {
